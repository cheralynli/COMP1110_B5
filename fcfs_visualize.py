...
def read_metrics_summary(file_path: str) -> List[Dict[str, float]]:
...
def bar_chart(labels: List[str], values: List[float], title: str, y_label: str, output_path: str) -> None:
...
def main() -> None:
    ...
    rows = read_metrics_summary(metrics_path)
